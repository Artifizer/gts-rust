...
fn test_op12_additional_properties_false_violation() {
    ...
    let result = store.validate_schema_chain("gts.x.test12.closed.account.v1~x.test12._.premium.v1~");
    assert!(
        result.is_err(),
...
fn test_op12_3level_progressive_tightening_ok() {
    ...
    let result =
        store.validate_schema_chain("gts.x.test12.cascade.msg.v1~x.test12._.sms.v1~x.test12._.short.v1~");
    assert!(
        result.is_ok(),
...
fn test_op12_3level_l3_violates_l2() {
    ...
    let result =
        store.validate_schema_chain("gts.x.test12.hier.base.v1~x.test12._.medium.v1~x.test12._.bad.v1~");
...
fn test_op12_property_disabled_fails() {
    ...
    let result = store.validate_schema_chain("gts.x.test12.order.base.v1~x.test12._.anon_order.v1~");
    assert!(
        result.is_err(),
